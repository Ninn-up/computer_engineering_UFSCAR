...
int main(void) {
    ...
    //Saída: distância média de cada um dos S objetos para seu k-ésimo vizinho mais próximo
    float soma = 0; // Acumulador das distâncias
    float media; // distância média
    ...
    for (int i = 0; i < S; i++){
        ...
        // Somando as distâncias aos vizinhos
        soma += vizinhos[i][k+1];
